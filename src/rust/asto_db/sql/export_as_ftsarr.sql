...
drop function if exists export_as_ftsarr_club(smallint);
create or replace function export_as_ftsarr_club(_op_mode smallint) 
returns table (
	club_id int
	, club_name text
	, cityid int
	, chief1_sur_name text
	, chief1_first_name text
) as $$
